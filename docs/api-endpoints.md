...
| Método | Ruta                                  | Acceso  | Descripción                                                                                                                                                                                                                                                                     |
| ------ | ------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/`                                   | Público / Admin | Lista productos. Filtros combinables: `?categoria=`, `?codigo=` (fragmento, 1 a 4 dígitos), `?nombre=`, `?marca=`, `?q=` (texto completo), `?destacado=true\|false`, `?activo=true\|false`. Para clientes solo devuelve productos activos (`activo !== false`). Con sesión de admin devuelve todos y permite filtrar por estado. |

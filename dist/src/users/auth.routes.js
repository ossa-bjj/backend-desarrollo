...
import { createUser, getAllUsers, getUserById, updateUser, updatePassword, updateStatus, deleteUser, } from './user.controller';
import { updateCustomer, updateSportsProfile, removeSportsProfile, addAddress, updateAddress, removeAddress, } from './user-profile.controller';
import { updateMembership, getMembershipPayments, addMembershipPayment, updateMembershipPayment, removeMembershipPayment, } from './user-membership.controller';
